...
CREATE TABLE `multa` (
  ...
  CONSTRAINT `multa_ibfk_4` FOREIGN KEY (`Id_estmul`) REFERENCES `est_multa` (`Id_estmul`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `multa_ibfk_1` FOREIGN KEY (`Id_usu`) REFERENCES `usuario` (`Id_usu`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `multa_ibfk_2` FOREIGN KEY (`Id_viv`) REFERENCES `vivienda` (`Id_viv`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `multa_ibfk_3` FOREIGN KEY (`Id_tmul`) REFERENCES `tipo_multa` (`Id_tmul`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `his_create_multa` AFTER INSERT ON `multa` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `his_update_multa` BEFORE UPDATE ON `multa` FOR EACH ROW BEGIN
INSERT INTO his_multa
   ( Id_hmul,
     Cod_hmul,
     Fch_hmul,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `his_delete_multa` BEFORE DELETE ON `multa` FOR EACH ROW BEGIN
INSERT INTO his_multa
   ( Id_hmul,
     Cod_hmul,
     Fch_hmul,
...
CREATE TABLE `observacion` (
  ...
  KEY `Id_cond` (`Id_cond`),
  KEY `Id_tobs` (`Id_tobs`),
  CONSTRAINT `observacion_ibfk_1` FOREIGN KEY (`Id_tobs`) REFERENCES `tipo_obs` (`Id_tobs`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `observacion_ibfk_2` FOREIGN KEY (`Id_cond`) REFERENCES `condominio` (`Id_cond`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `his_create_obs` AFTER INSERT ON `observacion` FOR EACH ROW BEGIN
INSERT INTO his_obs
   ( Id_hobs,
     Id_obs,
     Fch_hobs,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `his_update_obs` BEFORE UPDATE ON `observacion` FOR EACH ROW BEGIN
INSERT INTO his_obs
   ( Id_hobs,
     Id_obs,
     Fch_hobs,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `his_delete_obs` BEFORE DELETE ON `observacion` FOR EACH ROW BEGIN
INSERT INTO his_obs
   ( Id_hobs,
     Id_obs,
     Fch_hobs,
...
-- Dump completed on 2018-05-22 11:39:36

...
function Vrut(rutx){
{
    ...
    {
        document.getElementById('Verificacion').innerHTML="<i title='' class='glyphicon glyphicon-ok-sign'></i>";
	
        document.form1.newAdd.disabled='';
		
    }
    else
    {
        document.getElementById('Verificacion').innerHTML="<i title='' class='glyphicon glyphicon-question-sign'></i>";
        document.form1.newAdd.disabled='disabled';
    }
}
}